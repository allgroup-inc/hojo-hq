...
6. **本番化**
   ...
   - **特定商取引法に基づく表記、および個人情報保護方針(プライバシーポリシー)のページを作成し、購入前に閲覧できる位置に設置する。** 事業者名・所在地・連絡先・価格・支払方法・提供時期・返品/キャンセル方針の明示が必要(絶対ルール2の法務遵守に該当)。これらは実際の事業者情報が必要なため、小柳さん確認のうえで内容を確定させる
