...
description: >
  ...
  accent, the three-step gray text ladder, Meiryo (display/numerals/chrome) + Meiryo (body),
...
colors:
  ...
  text-muted: "#F88800"
  text-light: "#9A9A9A"
  accent-light: "rgba(248, 136, 0, 0.08)"
  accent-medium: "rgba(248, 136, 0, 0.15)"
  border: "rgba(248, 136, 0, 0.2)"
  card-bg: "rgba(248, 136, 0, 0.04)"
  positive: "#059669"
  negative: "#dc2626"
...
typography:
  # — reading ramp (Meiryo body + Meiryo chrome) —
  body:    { fontFamily: "Meiryo", cqw: 0.85, weight: 400, lineHeight: 1.6, color: "text-muted" }
  h4-eyebrow:{ fontFamily: "Meiryo", cqw: 0.8, weight: 600, tracking: "0.08em", upper: true, color: "primary" }
  tag:     { fontFamily: "Meiryo", px: 12, weight: 500, color: "primary" }
  counter: { fontFamily: "Meiryo", px: 13, weight: 500, tracking: "0.05em", color: "text-muted" }
  # — display / numerical ramp (Meiryo, near-black headings / cobalt numerals) —
  h3:      { fontFamily: "Meiryo", cqw: 1.25, weight: 500, lineHeight: 1.3, tracking: "-0.02em", color: "text" }
  stat-num:{ fontFamily: "Meiryo", cqw: 1.9, weight: 700, lineHeight: 1.0, color: "primary" }
  blockquote:{ fontFamily: "Meiryo", cqw: 2.4, weight: 500, lineHeight: 1.35, color: "text" }
  h2:      { fontFamily: "Meiryo", cqw: 2.6, weight: 600, lineHeight: 1.1, tracking: "-0.02em", color: "text" }
  metric-value:{ fontFamily: "Meiryo", cqw: 3.0, weight: 700, lineHeight: 1.0, color: "primary" }
  h1:      { fontFamily: "Meiryo", cqw: 4.2, weight: 700, lineHeight: 1.08, tracking: "-0.02em", color: "text" }
  quote-mark:{ fontFamily: "Meiryo", cqw: 8.0, weight: 700, lineHeight: 0.5, color: "primary", opacity: 0.15 }
...
- **Fonts** — already set to **Meiryo** (display) / **Noto Sans JP** (body); ignore any preset font name lingering in prose.
...
The voice is two faces in fixed roles: **Meiryo** (display, every numeral, all chrome —
eyebrows uppercase 0.08em) and **Meiryo** (body, muted gray, line 1.6). Headlines are near-black;
...
- **Meiryo** (display/numerals/chrome) + **Meiryo** (body) — near-black headlines, cobalt numerals.
...
Two ramps. The **reading ramp** (Meiryo body 0.85cqw muted; Meiryo eyebrow uppercase 0.08em
cobalt) carries copy + chrome; the **display/numerical ramp** (Meiryo `h3` 1.25cqw → `h1`
...
- **Headlines near-black, −0.02em**; **eyebrows cobalt, uppercase, 0.08em**; **numerals cobalt 600–700**; **body Meiryo 400 muted, line 1.6**. No italic, no uppercase body, no cobalt headline.
...
**Composes** accent-line, meta, h1, body sub. **Focal** a 2-line Meiryo `h1` near-black, left,
...
**Focal** a row of tinted cards — cobalt `metric-value` + Meiryo label + muted desc + optional
...
blockquote, cite. **Focal** a Meiryo `blockquote` near-black under a 15%-opacity cobalt
...
Meiryo body column beside a cobalt-8% highlight block (4px cobalt left rule) carrying an inline pull
...
a Meiryo `h1` near-black, centered, with the one solid cobalt `cta-button` pill below. **Accent**
...
- Use **tinted cards** (4% fill, 20% border, 10–14px radius, no shadow); body Meiryo 400 muted, line 1.6.
...
- **Type** — Meiryo headings −0.02em near-black, cobalt eyebrows 0.08em + numerals; Meiryo body muted line 1.6; ≥1.4cqw floor.
...
- **Meiryo + Meiryo via Google Fonts.** CJK pairing (Noto Sans SC 700 display / Noto Serif SC 400 body) carries over; the eyebrow's uppercase+tracking signal weakens in CJK — pair it with the accent-line.
