...
| 指標 | 値 | KPI | 判定 |
|---|---|---|---|
| 掲載制度数 | 28 件 | 常時150件以上 | 🟡 あと122件 |
| 検証済み | 28 件(100%) | 誤情報ゼロ | ✅ 全件検証済み |
| データ鮮度 | 2026-07-24 10:40 | 24時間以内 | ⚠ 190時間経過(要確認) |
| 市町村ページ | 41 ページ | 41市町村 | ✅ |
| 申請準備シート | 28 ページ | 全制度 | ✅ |

カテゴリ別: 子育て 9 / 教育 4 / 仕事・失業 4 / 生活支援 4 / 住まい 3 / 医療・健康 2 / 介護 1 / 防災・その他 1
