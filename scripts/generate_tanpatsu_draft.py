...
# 構成ルール
- 冒頭〜無料部分: 読者(沖縄・地方の中小企業経営者)が続きを読みたくなる具体的な数字を1つ以上出す
- 「====(ここから有料ライン)====」の行を1回だけ入れ、その後に本編(有料部分)を書く
- 有料部分は「事例の紹介 → そこから抽出できる共通の型 → 沖縄・地方の中小企業が明日から使える実務への翻訳」の順
- 事例を紹介するたびに、文中に出典(媒体名とURL)を明記する
- 分量: 全体で3,000〜4,500字程度
