...
SEEDS = [
    ...
    },
    {
        ...
        # 官公庁サイトのbot遮断で到達性チェックが間欠的に落ち、掲載から静かに消えた実績あり(2026-09-01 おもてなし総点検で検出)。手動確認済み扱いにする
        "assume_reachable": True,
        # 2026-09-01の一時欠落でDB引き継ぎのverifiedが消えたため、シード側に検証状態を復元
        # (新規昇格ではない。原本: 2026-08-31時点DB 1ea628af)
        "verified": True, "verified_at": "2026-07-23",
        "verified_by": "kensho(突合レポート○)+小柳さん進行承認 2026-07-23(2026-09-04 シードへ復元)",
    },
    {
    ...
    {
        "id": "fk-ken-shigaku-kyufukin-shitoritsu",
        "name": "沖縄県 私立奨学給付金",
        "category": "教育", "life_events": ["入園・入学", "低所得・生活苦"],
        "issuer": "沖縄県", "area": "沖縄県",
