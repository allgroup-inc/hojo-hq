...
(function () {
  ...
  // 稽古用の初期データ(すべて架空)
  seed("APO-DEMO-0001", "10:00", 60, "サンプル商店 田中様", "訪問", "那覇市おもろまち1-2-3", "営業一郎", "アポ花子", "高", "アポ確定");
  seed("APO-DEMO-0002", "13:00", 90, "テスト物産 比嘉様", "オンライン", "Zoom", "営業二郎", "アポ花子", "中", "スケジュール調整中");
  seed("APO-DEMO-0003", "15:00", 60, "見本工業 金城様", "来店", "本社2F", "営業一郎", "アポ花子", "低", "スケジュール調整中");
  seed("APO-DEMO-0004", "16:30", 60, "ダミー興産 上原様", "訪問", "浦添市", "営業三郎", "アポ花子", "高", "アポ確定");
