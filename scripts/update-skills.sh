...
INFRA_REPOS=(report-hq go allgroup-site enlife-mikomi skl-venue-hq hojo-signal kakei-crm)  # hojo-signalはfukugiiro org（要clone: fukugiiro/hojo-signal）

# ALLGROUP共通スキル(本店=hojo-hq)。ここに追加するとdrift防止対象が増える。
# social-media系8スキルは検出仕様(.claude/skills直下のみ走査)のためフラット配置(2026-08-07修正)
ALLGROUP_SKILL_NAMES=(humanizer resilient-agent-design mindshare-arbitrage multi-ai-crosscheck context-limit-handoff feature-factory hojo-lighthouse-triage go-link-discipline kgi-ksf-kpi-cascade lean-app-validation shiryo-sakusei taste-skill last30days
