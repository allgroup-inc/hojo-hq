...
キャプションをワンタップコピー→Instagramに貼るだけ。報告は投稿案メールへの返信で受ける
(2026-09-24 修正: それまでLINEでの返信をお願いしていたが、LINEは送信専用で
受信を処理する仕組みが無く、報告がどこにも残っていなかった)。
...
④ 投稿したら、<b>投稿案メールに返信</b>で「案1 投稿した」と一言(使わない案は「案4 なし」)<br><span style="color:#B9502F">※LINEはこちらから送る専用で、返信を受け取れません</span><br>
