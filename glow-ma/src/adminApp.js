...
(function (global) {
  ...
  var STYLE = [
    ...
    "#letterPageModal{width:min(460px,92vw); max-height:88vh;}",
    "#letterPageModal .km-body{padding:14px 18px 20px;}",
    "#letterPageModal iframe{width:100%; height:480px; border:1px solid var(--line); border-radius:10px; display:block;}",
